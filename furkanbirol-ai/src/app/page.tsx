...
export default function Home() {
  ...
  const t = {
    tr: {
      ...
      askSubtitle: 'CV’m, deneyimlerim ve projelerim hakkında sorular sormak için kullanabilirsin.',
      ...
      productAdoption: 'Ürün benimsenmesi: %20 artış',      competencies: 'Yetkinlikler',
    ...
    en: {
      ...
      askSubtitle: 'Powered by AI to answer your questions about my career, skills, and projects.',
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      {/* Sidebar */}
      <aside className="w-105 bg-white shadow-sm border-r border-gray-200 h-screen fixed left-0 top-0 overflow-y-auto">
        <div className="p-6">
          {/* Logo / Avatar */}
          ...
          {/* Core Competencies */}
          <div className="mb-8">
            <h3 className="text-sm font-semibold text-gray-800 uppercase tracking-wider mb-3">{t.competencies}</h3>
          ...
          {/* Key Achievements */}
          <div className="mb-8">
            <h3 className="text-sm font-semibold text-gray-800 uppercase tracking-wider mb-3">{t.achievements}</h3>
          ...
          {/* Certifications */}
          <div className="mb-8">
            <h3 className="text-sm font-semibold text-gray-800 uppercase tracking-wider mb-3">{t.certifications}</h3>
            <ul className="space-y-1 text-xs text-gray-600">
          ...
          {/* Technical Skills */}
          <div className="mb-8">
            <h3 className="text-sm font-semibold text-gray-800 uppercase tracking-wider mb-3">{t.skills}</h3>
          ...
          <div className="flex flex-col space-y-4 mt-6 text-sm">
            {/* Email */}
            <a href="mailto:furkanbirol@icloud.com" className="flex items-center space-x-2 text-gray-800 hover:text-blue-600 transition group">
            ...
            {/* Phone */}
            {/* <a href="tel:+905514198134" className="flex items-center space-x-2 text-gray-800 hover:text-green-600 transition group">
              <svg className="w-5 h-5 group-hover:scale-110 transition" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* LinkedIn, GitHub & WhatsApp - Yan Yana */}
      ...
      {/* Main Content */}
      <main className="flex-1 ml-105">

      {/* Header */}
      <header className="bg-white border-b border-gray-200 px-8 py-4 flex justify-between items-center">
        <nav className="flex space-x-6">
          <a href="/" className="text-blue-600 font-medium hover:text-blue-800 transition">{t.askTitle}</a>
        </nav>
        ...
        <div className="max-w-4xl mx-auto p-8 mt-10">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 mt-2">{t.askSubtitle}</p>
          </div>
